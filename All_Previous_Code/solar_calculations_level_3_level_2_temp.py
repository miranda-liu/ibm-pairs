...
for i in range(8783):
    ...
    temp_K_level_2.columns = ['PAIRS polygon ID level 2', 'averaged_value']
    ...
    #unit conversions
    temp_C_level_2 = temp_K_level_2 - K_to_C
    ...
    correct_shape_df_level_2['values'] = temp_C_level_2['averaged_value']
    ...
    temp_C_level_2_high_res = np.repeat(correct_shape_np_final, lcm_width / solar_level_2_width, axis=1)
    temp_C_level_2_high_res = np.repeat(temp_C_level_2_high_res, lcm_height / solar_level_2_height, axis=0)
    temp_C = np.reshape(temp_C_level_2_high_res, (lcm_height * lcm_width), order = 'F')
...
tracking_solar_output.to_csv(r'C:\Users\ChemeGrad2019\Desktop\IBM_PAIRS\New_data_format\tracking_solar_output_level_3_and_temp_level_2.csv')