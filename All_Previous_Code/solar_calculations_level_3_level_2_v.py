...
for i in range(8783):
    ...
    v_level_2.columns = ['PAIRS polygon ID level 2', 'averaged_value']
    ...
    correct_shape_df_level_2['values'] = v_level_2['averaged_value']
    ...
    v_level_2_high_res = np.repeat(correct_shape_np_final, lcm_width / solar_level_2_width, axis=1)
    v_level_2_high_res = np.repeat(v_level_2_high_res, lcm_height / solar_level_2_height, axis=0)
    v = np.reshape(v_level_2_high_res, (lcm_height * lcm_width), order = 'F')
...
tracking_solar_output.to_csv(r'C:\Users\ChemeGrad2019\Desktop\IBM_PAIRS\New_data_format\tracking_solar_output_level_3_and_wind_level_2.csv')