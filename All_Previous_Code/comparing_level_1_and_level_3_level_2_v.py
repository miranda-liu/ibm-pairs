...
solar_power_output_level_2_3_combo = pd.read_csv(r'C:\Users\ChemeGrad2019\Desktop\IBM_PAIRS\New_data_format\solar_power_output_sum_GWh_level_3_level_2_wind.csv')
...
#plt.colorbar()
plt.title('Percent error in energy output annual sum level 2 and level 3 wind')
plt.clim(-10, 10)
plt.show()
...
plt.title('Error distribution level 2 and level 3 wind')#, fontweight="bold")
