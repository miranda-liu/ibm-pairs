...
for i in range(8783):
    ...
    temp_K_level_3 = temp_K_level_3.iloc[:, 0]
    temp_K_level_3 = pd.DataFrame(temp_K_level_3)
    temp_K_level_3_shape_df = pd.DataFrame(index = range(50), columns = ['Values'])
    temp_K_level_3_shape_df['Values'] = temp_K_level_3
    temp_K_level_3_shape_np = temp_K_level_3_shape_df.to_numpy()
    temp_K_level_3_np_final = np.reshape(temp_K_level_3_shape_np, (solar_level_3_height, solar_level_3_width), order='F')

    temp_K_level_3_high_res = np.repeat(temp_K_level_3_np_final, lcm_width / solar_level_3_width, axis=1)
    temp_K_level_3_high_res = np.repeat(temp_K_level_3_high_res, lcm_height / solar_level_3_height, axis=0)
    ...
    temp_K_level_3_df_final = pd.DataFrame(temp_K_level_3_high_res)
    temp_K_level_1_df_final = pd.DataFrame(temp_K_level_1_high_res)

    if i == 0:
        temp_error_sum_high_res = abs(temp_K_level_3_df_final - temp_K_level_1_df_final)
    else:
        temp_error_sum_high_res += abs(temp_K_level_3_df_final - temp_K_level_1_df_final)
    ...
    wind_level_3 = pd.read_csv(r'C:\Users\ChemeGrad2019\Desktop\IBM_PAIRS\New_data_format\Spatially_aggregated_level_3//' + 'Global weather (ERA5)-wind value-' + current_timestamp + 'level_3.csv')  # K
    wind_level_3.columns = ['PAIRS polygon ID level 3', 'averaged value']
    wind_level_3 = wind_level_3.set_index('PAIRS polygon ID level 3', drop=True)
    wind_level_3_shape_df = pd.DataFrame(index = range(50), columns = ['Values'])
    wind_level_3_shape_df['Values'] = wind_level_3
    wind_level_3_shape_np = wind_level_3_shape_df.to_numpy()
    wind_level_3_np_final = np.reshape(wind_level_3_shape_np, (solar_level_3_height, solar_level_3_width), order='F')

    wind_level_3_high_res = np.repeat(wind_level_3_np_final, lcm_width / solar_level_3_width, axis=1)
    wind_level_3_high_res = np.repeat(wind_level_3_high_res, lcm_height / solar_level_3_height, axis=0)
    ...
    wind_level_3_df_final = pd.DataFrame(wind_level_3_high_res)
    wind_level_1_df_final = pd.DataFrame(wind_level_1_high_res)

    if i == 0:
        wind_error_sum_high_res = abs(wind_level_3_df_final - wind_level_1_df_final)
    else:
        wind_error_sum_high_res += abs(wind_level_3_df_final - wind_level_1_df_final)
    ...
    I_level_3 = pd.read_csv(r'C:\Users\ChemeGrad2019\Desktop\IBM_PAIRS\New_data_format\Spatially_aggregated_level_3//' + 'Global weather (ERA5)-Solar radiation-' + current_timestamp + 'level_3.csv')  # K
    I_level_3.columns = ['PAIRS polygon ID level 3', 'averaged value']
    I_level_3 = I_level_3.set_index('PAIRS polygon ID level 3', drop=True)
    I_level_3 = I_level_3.iloc[:, 0]
    I_level_3 = pd.DataFrame(I_level_3)
    I_level_3_shape_df = pd.DataFrame(index = range(50), columns = ['Values'])
    I_level_3_shape_df['Values'] = I_level_3
    I_level_3_shape_np = I_level_3_shape_df.to_numpy()
    I_level_3_np_final = np.reshape(I_level_3_shape_np, (solar_level_3_height, solar_level_3_width), order='F')

    I_level_3_high_res = np.repeat(I_level_3_np_final, lcm_width / solar_level_3_width, axis=1)
    I_level_3_high_res = np.repeat(I_level_3_high_res, lcm_height / solar_level_3_height, axis=0)
    ...
    I_level_3_df_final = pd.DataFrame(I_level_3_high_res)
    I_level_1_df_final = pd.DataFrame(I_level_1_high_res)

    if i == 0:
        I_error_sum_high_res = abs(I_level_3_df_final - I_level_1_df_final)
    else:
        I_error_sum_high_res += abs(I_level_3_df_final - I_level_1_df_final)
    ...
    snow_level_3 = pd.read_csv(r'C:\Users\ChemeGrad2019\Desktop\IBM_PAIRS\New_data_format\Spatially_aggregated_level_3//' + 'Global weather (ERA5)-Snow depth-' + current_timestamp + 'level_3.csv')  # K
    snow_level_3.columns = ['PAIRS polygon ID level 3', 'averaged value']
    snow_level_3 = snow_level_3.set_index('PAIRS polygon ID level 3', drop=True)
    snow_level_3 = snow_level_3.iloc[:, 0]
    snow_level_3 = pd.DataFrame(snow_level_3)
    snow_level_3_shape_df = pd.DataFrame(index = range(50), columns = ['Values'])
    snow_level_3_shape_df['Values'] = snow_level_3
    snow_level_3_shape_np = snow_level_3_shape_df.to_numpy()
    snow_level_3_np_final = np.reshape(snow_level_3_shape_np, (solar_level_3_height, solar_level_3_width), order='F')

    snow_level_3_high_res = np.repeat(snow_level_3_np_final, lcm_width / solar_level_3_width, axis=1)
    snow_level_3_high_res = np.repeat(snow_level_3_high_res, lcm_height / solar_level_3_height, axis=0)
    ...
    snow_level_3_df_final = pd.DataFrame(snow_level_3_high_res)
    snow_level_1_df_final = pd.DataFrame(snow_level_1_high_res)

    if i == 0:
        snow_error_sum_high_res = abs(snow_level_3_df_final - snow_level_1_df_final)
    else:
        snow_error_sum_high_res += abs(snow_level_3_df_final - snow_level_1_df_final)
...
plt.imshow(temp_error_sum_high_res_np, cmap = 'Reds', aspect = 5) #aspect = pixels in length / pixels in width??
plt.colorbar()
plt.clim(0, 10)
plt.title('Hourly temperature error at level 3 (K)')
plt.show()
...
plt.title('Temperature error distribution at level 3')#, fontweight="bold")
...
#make a heatmap out of
plt.imshow(wind_error_sum_high_res_np, cmap = 'Blues', aspect = 5) #aspect = pixels in length / pixels in width??
plt.colorbar()
plt.clim(0, 3.5)
plt.title('Hourly wind error at level 3 (m/s)')
plt.show()
...
plt.title('Wind error distribution at level 3')#, fontweight="bold")
...
#make a heatmap out of
plt.imshow(I_error_sum_high_res_np, cmap = 'Purples', aspect = 5) #aspect = pixels in length / pixels in width??
plt.colorbar()
plt.clim(0, 160000)
plt.title('Hourly irradiance error at level 3 (J/m^2)')
plt.show()
...
plt.title('Irradiance error distribution at level 3')#, fontweight="bold")
...
#make a heatmap out of
plt.imshow(snow_error_sum_high_res_np, cmap = 'Greens', aspect = 5) #aspect = pixels in length / pixels in width??
plt.colorbar()
plt.clim(0, 0.1)
plt.title('Hourly snow error at level 3 (m.w.e.)')
plt.show()
...
plt.title('Snow error distribution at level 3')#, fontweight="bold")
