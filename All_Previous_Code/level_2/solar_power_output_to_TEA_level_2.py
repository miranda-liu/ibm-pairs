...
LCOE_shape_df = pd.DataFrame(index = range(384), columns = ['LCOE'])
LCOE_shape_df['LCOE'] = LCOE
LCOE_shape_np = LCOE_shape_df.to_numpy()
LCOE_shape_np_final = np.reshape(LCOE_shape_np, (12, 32), order = 'F')
...
LCOE_shape_df_final.to_csv(r'C:\Users\ChemeGrad2019\Desktop\IBM_PAIRS\New_data_format\level_2\solar_LCOE_level_2.csv')
