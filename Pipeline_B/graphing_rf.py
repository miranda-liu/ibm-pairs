...
import numpy as np
import rf_calculations
import csv
import cf_generator
import statistics

vre_type = cf_generator.vre_type
years = rf_calculations.years
...
with open('/Users/mirandaliu/Documents/GitHub/ibm-pairs/Pipeline_B/' + vre_type +'_reliability_factors.csv') as file_obj:
    # skip header
